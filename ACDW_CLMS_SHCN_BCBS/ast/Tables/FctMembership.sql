CREATE TABLE [ast].[FctMembership] (
    ...
    [LoadDate]                    DATE            NULL,
    [stgRowStatus]                VARCHAR (20)    CONSTRAINT [DF_astFctMbr_StgRowStatus] DEFAULT ('Not Valid') NOT NULL,
    ...
    CONSTRAINT [CK_FctMbr_stgRowStatus] CHECK ([stgRowStatus]='Exported' OR [stgRowStatus]='Valid' OR [stgRowStatus]='Loaded' OR [stgRowStatus]='Not Valid')
);


GO
CREATE NONCLUSTERED INDEX [astFctMbrDev_StgRowStatus]
    ON [ast].[FctMembership]([stgRowStatus] ASC)
    INCLUDE([FctMembershipSkey], [LoadDate]);
