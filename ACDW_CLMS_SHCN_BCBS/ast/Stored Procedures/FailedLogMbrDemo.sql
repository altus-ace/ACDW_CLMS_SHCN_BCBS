...
CREATE PROCEDURE [ast].[FailedLogMbrDemo]
...
BEGIN TRAN
					...
					DECLARE @JobName VARCHAR(100) = 'FailedLogMbrDemo';
	...
	LEFT JOIN
						(
									...
									AND			DataDate = (Select MAX(DataDate) From ast.MbrStg2_MbrData Where ClientKey = 16 )
