...
CREATE PROCEDURE dbo.x_adi_NormalizeTable
(   
...
/***
EXEC dbo.x_adi_NormalizeTable '[adi].[Steward_BCBS_InstitutionalClaim]','01-01-2021','dbo.z_tmp_LLKeyTbl'
DROP TABLE dbo.z_tmp_KeyTbl
DROP TABLE dbo.z_tmp_LoadDates
SELECT DISTINCT SrcLoadDate, RecStatus, count(*) as CntRec FROM dbo.z_tmp_KeyTbl GROUP BY SrcLoadDate, RecStatus ORDER BY SrcLoadDate, RecStatus
