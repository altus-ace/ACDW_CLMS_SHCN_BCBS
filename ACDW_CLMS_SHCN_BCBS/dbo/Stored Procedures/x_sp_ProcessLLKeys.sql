...
CREATE PROCEDURE dbo.x_sp_ProcessLLKeys
(   
...
/***
EXEC dbo.x_sp_ProcessHLKeys '[adi].[Steward_BCBS_InstitutionalClaim]','01-01-2021','dbo.z_tmp_LLKeyTbl'

SELECT DISTINCT SrcLoadDate, RecStatus, count(*) as CntRec FROM dbo.z_tmp_LLKeyTbl GROUP BY SrcLoadDate, RecStatus ORDER BY SrcLoadDate, RecStatus
SELECT * FROM dbo.z_tmp_LLKeyTbl
***/
