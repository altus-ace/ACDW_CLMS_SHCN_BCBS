...
/***
01.18.21 SN - Update to pull from adw.QM_ResultsByMemberHistory (has addressed flg) instead of claims data only (2020_tvf_Get_AWVisits)
...
-- Current Membership
LEFT JOIN  [adw].[2020_tvf_Get_ActiveMembersFull]	(@RunDate) a
...
/***
EXEC [adw].[CalcfctADWVisits] 16,'01-15-2021','01-01-2020','09-30-2020'

SELECT * --DISTINCT(ClientMemberKey) as DstMbr--, PrimaryServiceDate
-- DELETE 
-- SELECT DISTINCT CONVERT(DATE,CreatedDate)
