...
CREATE PROCEDURE [adw].[CalcfctOutpatientVisits]
	(
...
BEGIN
	...
	INSERT INTO [adw].[FctOutpatientVisits]
         (
         [SrcFileName]
         ,[LoadDate]
         ,[DataDate]
         ...
         ,[ClaimType]
		   ...
		   ,[SvcNPISpecialty]
         ,[AttNPISpecialty])
	SELECT  DISTINCT CONCAT('[adw].[CalcfctOutpatientVisits]',@KPIStartDate,'-',@KPIEndDate)
			,GETDATE()
			,@RunDate
			,a.ClientKey
			,a.ClientMemberKey
		...
		JOIN [adw].[2020_tvf_Get_OPVisits] (@KPIStartDate,@KPIEndDate) b
...
/***
EXEC [adw].[CalcfctOutpatientVisits] 20,'03-15-2021','01-01-2019','12-31-2020'

SELECT *
FROM truncate table [adw].[FctOutpatientVisits]
***/
