...
BEGIN TRAN
						...
						DECLARE @JobName VARCHAR(100) = 'SHCN BCBS MbrMember';
	...
	FROM				
						(
									...
									SELECT 	
												...
												,ast.LoadDate
												,ast.DataDate
												,@EffectiveDate 					AS EffectiveDate --- ast.[plnClientPlanEffective]
									...
									AND			plnClientPlanEffective =  @EffectiveDate 
						) AS Src
	...
	/*
	USAGE
	[adw].[PdwMbr_02_LoadMember]'2021-02-18','P',20,'2021-02-01'
	*/
	--Validation
	/*
